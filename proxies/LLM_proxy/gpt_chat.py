...
class GPTChat:
    def __init__(self):
        ...
        self.memory = ConversationBufferMemory(human_prefix="Human", input_key="input")
    ...
    def ask_gpt_about_commit(self, diff, commit_data):
        ...
        user_inputs = [
            ...
            'First of all, keep the following points about commit message analysis in mind:\n""" - Descriptive Message: A clear and descriptive commit message often indicates a well-thought-out change. Look for specific, action-oriented verbs (e.g., "fix", "add", "remove", "refactor", "modify", "debug").\n'
