...
class Repository:
    ...
    def analyze_commits(self):
        ...
        arranged_commits = self._arrange_commits(commits, desired_commits)
        ...
        diff_stats = self.commit_analyzer.calculate_diff_stats(arranged_commits)
        density_warnings = self.density_analyzer.analyze_density(time_diffs, commits)
